...
resource "google_container_cluster" "cluster" {
  ...
  # "default node pool"  of nodes.
  # So, we need to set an initial_node_count of 1.
  ...
  node_config {
   ...
   release_channel {
    channel = var.release_channel // or less frequently update fro production STABLE, REGULAR
    }
